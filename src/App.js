...
function App() {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText('8XBGBQDHnnB1X2XgZsVqgnd3MPaAfqUGTQjZU3wSpump');
    setCopied(true);
  ...
  return (
    <div className="relative h-screen w-screen overflow-hidden flex justify-center items-center">
      <div className='absolute top-5 right-5 flex justify-center items-center z-10'>
        <a href="https://x.com/godmodesol" className=''>
        ...
        <a href="https://t.me/godportalsol" className=''>
          <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" className='size-10 md:size-12 md:hover:scale-105 transition ease-in-out duration-150' fill="#FDE047" viewBox="0 0 50 50">
      ...
      >
        <div className="font-custom flex flex-col sm:flex-row justify-center bg-slate-100 z-10 items-center gap-1 md:gap-3 px-5 py-3 max-w-full border-2 border-amber-800">
          ...
          8XBGBQDHnnB1X2XgZsVqgnd3MPaAfqUGTQjZU3wSpump
          </div>
        </div>
      </motion.div>
    </div>
